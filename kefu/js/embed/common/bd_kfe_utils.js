...
var bd_kfe_utils = {
  ...
  is_self: function(message) {
    return message.user.username === bd_kfe_data.username;
  },
  // 发送状态
  ...
  pushToMessageArray: function(message) {
    ...
    if (bd_kfe_utils.is_type_notification(message)) {
      ...
      if (bd_kfe_utils.is_type_text(message)) {
        content += "<div class='byteDesk-text'>" + 
        ...
        content +=
          "<div class='byteDesk-text'>" +
          "<img src='https://www.bytedesk.com/img/input/file.png' alt='[文件]' style='file' onclick=\"bd_kfe_utils.fileClicked('" +
