...
$(document).ready(function () {
  ...
  layui.use(['layer', 'form', 'upload'], function(){
    ...
    data.feedbackLayer = layer;
    var form = layui.form;
    data.feedbackForm = form;
    ...
    //监听提交
    form.on('submit(formFeedback)', function(data){
      ...
      var fileUrl = '';
      //
      httpapi.createFeedback(cid, content, mobile, email, fileUrl);
      //
      return false;
    });
