...
var utils = {
    ...
    leaveComment: function() {
        ...
        console.log('leaveComment:', forumComment);
        httpapi.commentArticle(data.aid, forumComment);
    },
    // 提问
    // ask: function() {
    //     var title = $("#forumAskTitle").val();
    //     var content = $("#forumAskContent").val();
    //     if (title.trim().length != 0 && content.trim().length != 0) {
    //         httpapi.ask(title, content);
    //     } else {
    //         alert("标题 或 内容 不能为空");
    //     }
    // }
